...
{
    /// <summary>
    /// Drop-in replacement for <see cref="System.UInt16"/> that obfuscates the value in memory and reports tampering to the <see cref="PrimitiveCheatingDetector"/>.
    /// </summary>
    ...
    public struct ProtectedUInt16 : IProtected, IDisposable, ISerializationCallbackReceiver
    {
        ...
        /// <returns>A protected UInt16 holding the given value.</returns>
        ...
        /// </summary>
        /// <param name="_Value">Protected UInt16 to unwrap.</param>
        /// <returns>The unobfuscated UInt16 value.</returns>
