...
{
    /// <summary>
    /// GuardingPearSoftware company landing page shown under Project Settings; lists the company's products.
    /// </summary>
    public class CompanyWindow
    {
        /// <summary>
        /// Builds the <see cref="SettingsProvider"/> shown in Project Settings under "GuardingPearSoftware".
        /// </summary>
        ...
        /// <summary>
        /// Populates the product catalog on first activation. No-op if already populated.
        /// </summary>
        ...
        /// <summary>
        /// Product categories rendered in the window.
        /// </summary>
        private static List<ProductCategory> productCategories;

        /// <summary>
        /// A single product entry shown as a card in the window.
        /// </summary>
        ...
        /// <summary>
        /// A named group of products with a short description.
        /// </summary>
        ...
        /// <summary>
        /// Renders the company landing page (header, scrollable area, and one card grid per product category).
        /// </summary>
        /// <param name="_SearchContext">Project Settings search context (unused).</param>
        private static void GetGui(String _SearchContext)
        {
            try
            {
                ...
                // Transparent button style for header buttons.
