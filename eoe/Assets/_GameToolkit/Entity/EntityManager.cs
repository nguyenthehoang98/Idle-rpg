...
namespace _KITSystem.Entity
{
    public static class EntityManager
    {
        ...
        public static void DelEntity(int entity)
        {
        ...
        public static void PostEvent(int eventId, int entity, params Parameter[] parameters)
        {
            #if DEBUG
        ...
        public static bool IsEntityAlive(int entity)
        {
