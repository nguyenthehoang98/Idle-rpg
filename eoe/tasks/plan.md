...
| 2 | Board và combat integration | In progress - B-01/B-03 complete |
...
| 3 | Combat slice | Làm B-01 đến B-05 | Một wave có Overdrive hoạt động | Đang làm — B-01/B-03 xong |
...
**Next action:** bắt đầu `B-04` bằng ba Overdrive identity và giữ combat slice nhỏ. Không mở rộng content trước khi Checkpoint B pass.
