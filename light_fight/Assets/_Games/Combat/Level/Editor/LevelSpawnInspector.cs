...
namespace _Games.Combat.Level.Editor
{
    [CustomEditor(typeof(LevelSpawnSO))]
    public class LevelSpawnInspector : UnityEditor.Editor
    {
        ...
        {
            if (target is LevelSpawnSO config) config.Disable();
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.enabled = true;
            EditorGUILayout.PropertyField(serializedObject.FindProperty("design"));
        ...
        private void DrawBatchSelector(SerializedProperty batches)
        {
            ...
            if (GUILayout.Button("+ Add Batch", GUILayout.Height(22)))
            {
                ...
                batches.arraySize++;
                batches.GetArrayElementAtIndex(last).boxedValue = new LevelSpawnSO.BatchSpawn();
        ...
        private void DrawMonsterWeights(int batchIndex, SerializedProperty batch)
        {
            ...
            if (GUILayout.Button("+", GUILayout.Width(25)))
            {
                ...
                enemies.arraySize++;
                enemies.GetArrayElementAtIndex(last).boxedValue = new LevelSpawnSO.EnemySpawn();
            }
