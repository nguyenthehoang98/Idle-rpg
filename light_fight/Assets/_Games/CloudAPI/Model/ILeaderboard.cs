...
namespace _Games.CloudAPI.Model
{
    ...
    {
        UniTask<(RequestResult result, PlayerRankResult rankResult)> SubmitResultBattle(LoginSessionResult session, MatchingSubmitRequest[] requests);
        ...
        UniTask<(RequestResult result, FindOpponentResult[] opponents)> FindOpponent(LoginSessionResult session);
    }
}