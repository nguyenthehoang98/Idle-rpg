...
{
    public class ConeMono : MonoBehaviour
    {
        [TitleGroup("Settings")] 
        ...
        public WeaponMono WeaponMono => weaponMono;
        ...
        public UniTask Initialize(int order, int maxStar, float timeScale)
        {
            ...
            isInitialized = true;
            weaponMono.Initialize(zPivots[order], xPivots[order], timeScale);
#if UNITY_EDITOR
            weaponMono.name = "Weapon " + order;
#endif
        ...
        public float Play()
        {
            ...
            this.WaitInvoke(d1, weaponMono.Play);
