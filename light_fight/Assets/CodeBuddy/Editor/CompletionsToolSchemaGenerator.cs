...
// Type: CodeBuddy.CompletionsToolSchemaGenerator
...
namespace CodeBuddy
{
  internal class CompletionsToolSchemaGenerator : IToolSchemaGenerator
  {
    ...
    private void PopulateTypeInfo(Type type, Dictionary<string, object> schema)
    {
      ...
      else if (type.IsClass && type != typeof (string))
      {
        ...
        schema[nameof (type)] = (object) CompletionsToolSchemaGenerator.GetJsonType(type);
    }
