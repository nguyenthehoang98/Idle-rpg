...
// Type: CodeBuddy.OpenAiToolSchemaGenerator
...
namespace CodeBuddy
{
  internal class OpenAiToolSchemaGenerator : IToolSchemaGenerator
  {
    ...
    private void PopulateTypeInfo(Type type, Dictionary<string, object> schema)
    {
      ...
      else if (type.IsClass && type != typeof (string))
      {
        ...
        schema[nameof (type)] = (object) OpenAiToolSchemaGenerator.GetJsonType(type);
    }
