...
// Type: CodeBuddy.ClaudeToolSchemaGenerator
...
namespace CodeBuddy
{
  internal class ClaudeToolSchemaGenerator : IToolSchemaGenerator
  {
    ...
    private void PopulateTypeInfo(Type type, Dictionary<string, object> schema)
    {
      ...
      else if (type.IsClass && type != typeof (string))
      {
        ...
        schema[nameof (type)] = (object) ClaudeToolSchemaGenerator.GetJsonType(type);
    }
